			  ...
			  // </button></div>");
 									...
 									<table border="0" width="100%">
 										<tr>
 											...
 											<td width="76%">
 												<input type="month" class="form-control"  id="keyword" name="keyword" placeholder="Type keyword here Date" value="" size="1" style="width: all;">
 											</td>
 											...
 											<td>
													...
													<table data-toggle="table" class="table table-striped table-bordered table-hover header-fixed" id="sample_xx">
														...
														<thead>
															<tr>
																	...
																	<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																		<font face="Calibri" size="2">Judul
																		</font>
																	</th>
                                                                    ...
                                                                    <th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																		<font face="Calibri" size="2">Nama File
																		</font>
																	</th>
                                                                    <?php
                                                                    if($jabatan != "Agent TAM"){
                                                                    ?>
																	<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
																		<div align="center">
															...
															if (isset($_POST['Search']) AND !($_POST['keyword'] == '')) {
                                                                $month=substr($keyword,5);
                                                                $year=substr($keyword,0,4);
																$sqlo="SELECT id, username_input, nama_input, judul, ket, tgl_input, nama_file FROM news where MONTH(tgl_input) = '$month'  AND YEAR(tgl_input) = '$year' ORDER BY tgl_input DESC";
															}else{
																$sqlo="SELECT id, username_input, nama_input, judul, ket, tgl_input, nama_file FROM news ORDER BY tgl_input DESC";
															}
						                        ...
						                        # code...
																...
																<tbody>
																	...
																	<td style="padding-top: 2px; padding-bottom: 2px">
																		<font face="Calibri" size="2"><?php echo date("d F Y",strtotime($sqlop[5]));?>
																	</font>
																</td>

																<td style="padding-top: 2px; padding-bottom: 2px">
																	<font face="Calibri" size="2"><?php echo $sqlop[3];?>
																</font>
															</td>
                                                            ...
                                                            <td style="padding-top: 2px; padding-bottom: 2px">
																	<font face="Calibri" size="2"><a href="http://10.194.176.158/kinerja_tam/app/uploads/<?php echo $sqlop[6];?>"><?php echo $sqlop[6];?></a>
																</font>
															</td>
                                                            <?php
                                                                if($jabatan != "Agent Fbcc"){
                                                            ?>
															<td style="padding-top: 2px; padding-bottom: 2px">
																<div align="center">
																	<font face="Verdana" style="font-size: 9pt">

																		<a href="edit_news.php?id=<?php echo $sqlop[0];?>&judul=<?php echo $sqlop[3];?>&ket=<?php echo $sqlop[4];?>">
																		...
																		<a href="delete_news.php?id=<?php echo $sqlop[0];?>" onclick="javascript: return(delete_data(<?php echo $sqlop[0];?>,<?php echo $sqlop[3];?>))" title="Delete News">
...
<script>
	...
	{
		return confirm('Hapus data dengan judul : '+judul+' ?');
	}
