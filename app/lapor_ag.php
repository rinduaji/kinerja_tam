...
$pkatt = mysqli_query($conn, "SELECT b.user1,b.user2,b.user3,b.user7,a.nama_tl FROM cc147_main_users as a, cc147_main_users_extended as b WHERE a.username=b.user1 and b.user3='Agent TAM' and b.user2='$agent_id'");
...
// $sql3="SELECT app_kinerja_tab.tanggal,app_kinerja_tab.record_id,app_kinerja_tab.tgl_record,app_kinerja_nilai.tglrecord,app_kinerja_tab.durasi,app_kinerja_tab.customer_needs,app_kinerja_tab.service_technique,app_kinerja_tab.QM,app_kinerja_tab.rekomendasi FROM app_kinerja_tab Inner Join app_kinerja_nilai on app_kinerja_nilai.user_id = app_kinerja_tab.user_id and app_kinerja_nilai.tanggal = app_kinerja_tab.tanggal where app_kinerja_tab.user_id='$agent_id' and app_kinerja_nilai.tanggal LIKE '%$bulan%' ORDER BY tanggal asc";
								$sql3="SELECT tanggal,ani,tglrecord,durasi,proses_layanan,sikap_layanan,human,smile_voice FROM app_kinerja_nilai WHERE user_id='$agent_id' AND tanggal LIKE  '%$bulan%' AND tanggal between '2020-07-01' AND '2020-07-29' ORDER BY tanggal asc";
//echo "$sql3";
//die();
...
// $sql3="SELECT app_kinerja_tab.tanggal,app_kinerja_tab.record_id,app_kinerja_tab.tgl_record,app_kinerja_nilai.tglrecord,app_kinerja_tab.durasi,app_kinerja_tab.customer_needs,app_kinerja_tab.service_technique,app_kinerja_tab.QM,app_kinerja_tab.rekomendasi FROM app_kinerja_tab Inner Join app_kinerja_nilai on app_kinerja_nilai.user_id = app_kinerja_tab.user_id and app_kinerja_nilai.tanggal = app_kinerja_tab.tanggal where app_kinerja_tab.user_id='$agent_id' and app_kinerja_nilai.tanggal LIKE '%$bulan%' ORDER BY tanggal asc";
								$sql3="SELECT tanggal,ani,tglrecord,durasi,proses_layanan,sikap_layanan,human,smile_voice FROM app_kinerja_nilai WHERE user_id='$agent_id' AND tanggal LIKE  '%$bulan%' ORDER BY tanggal asc";
//echo "$sql3";
//die();
								$query=mysqli_query($conn,$sql3);
// $queryc=mysql_query($sqlc);
