										...
										<tr>
											...
											<td>
												...
												<!-- <th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
													...
													<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
														<font face="Verdana" style="font-size: 9pt">Login QCO
														</font>
													</th>
													<th style="padding-top: 3px; padding-bottom: 3px; background-color: #EAEAEA !important">
											...
											if($_POST['keyword'] == "" OR $_POST['keyword'] == null){
												if(!isset($_POST['search'])){
													while ( $qq <= date('m')) {
														...
														if($jb == "Tabber TAM") {
															$sql=mysqli_query($conn,"Select  u.user7,kn.lup_qa,kn.tanggal, COUNT(*), kn.user_id FROM app_kinerja_nilai as kn INNER JOIN cc147_main_users_extended as u ON kn.lup_qa=u.user1 WHERE MONTH(tanggal) = '$qq' AND YEAR(tanggal) = '$q' AND kn.lup_qa = '$ss' GROUP BY user_id order by area");
														} else {
															$sql=mysqli_query($conn,"Select  u.user7,kn.lup_qa,kn.tanggal, COUNT(*), kn.user_id FROM app_kinerja_nilai as kn INNER JOIN cc147_main_users_extended as u ON kn.lup_qa=u.user1 WHERE MONTH(tanggal) = '$qq' AND YEAR(tanggal) = '$q' GROUP BY user_id order by area");	
														}
						...
						//echo "$qq";
													...
													<!-- <td style="padding-top: 2px; padding-bottom: 2px">
														<font face="Tahoma" style="font-size: 9pt">
															...
															<td style="padding-top: 2px; padding-bottom: 2px">
																<a href="rep_tap_tabber_detail.php?area=<?php echo $row[0];?>&login_agent=<?php echo $row[4];?>&login_tabber=<?php echo $row[1];?>&bulan=<?php echo $month;?>&tahun=<?php echo $year;?>" class="btn btn-primary btn-sm">Detail</a>
															</td>
